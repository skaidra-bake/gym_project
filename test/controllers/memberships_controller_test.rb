...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { m_id: @membership.m_id, m_name: @membership.m_name, price: @membership.price } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { m_id: @membership.m_id, m_name: @membership.m_name, price: @membership.price } }
